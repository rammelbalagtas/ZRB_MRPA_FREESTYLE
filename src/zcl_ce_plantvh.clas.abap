CLASS zcl_ce_plantvh DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
      ...
      WHEN `ZCE_PLANTVH`.
        TRY.
            ...
            IF io_request->is_data_requested( ).
              DATA lt_data TYPE STANDARD TABLE OF zce_plantvh.
              APPEND INITIAL LINE TO lt_data ASSIGNING FIELD-SYMBOL(<fs_data>).
              <fs_data>-plant = 'YYZA'.
              <fs_data>-name = '1st inventory (Consumer)'.
              APPEND INITIAL LINE TO lt_data ASSIGNING <fs_data>.
              <fs_data>-plant = 'YYZB'.
              <fs_data>-name = '1st inventory (Industrial)'.
