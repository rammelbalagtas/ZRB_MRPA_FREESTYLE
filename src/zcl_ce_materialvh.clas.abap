CLASS zcl_ce_materialvh DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ce_materialvh IMPLEMENTATION.

  METHOD if_rap_query_provider~select.
    CASE io_request->get_entity_id( ).
      WHEN `ZCE_MATERIAL_VH`.
        TRY.
            "filter
            ...
            IF io_request->is_data_requested( ).
              DATA lt_data TYPE STANDARD TABLE OF zce_material_vh.
              APPEND INITIAL LINE TO lt_data ASSIGNING FIELD-SYMBOL(<fs_data>).
              <fs_data>-productid = 'KXTGD390A'.
              <fs_data>-name = 'Material 1'.
              APPEND INITIAL LINE TO lt_data ASSIGNING <fs_data>.
              <fs_data>-productid = 'KXTGD390B'.
              <fs_data>-name = 'Material 2'.
              APPEND INITIAL LINE TO lt_data ASSIGNING <fs_data>.
              <fs_data>-productid = 'KXTGD390C'.
              <fs_data>-name = 'Material 3'.
              APPEND INITIAL LINE TO lt_data ASSIGNING <fs_data>.
              <fs_data>-productid = 'KXTGD390D'.
              <fs_data>-name = 'Material 4'.
